            ...
            <li><a href="#"><span class="glyphicon glyphicon-warning-sign"></span> Forgot Password?</a></li>
                                ...
                                <div style="padding-top:100px" class="container">
                                    <div style=" text-align:left" class="row">
                                        <div align="center" style="background-color:rgb(204,204,204)" class="col-md-4">
                                            <br/><br/>
                                            <h3 align="center">Login in your account</h3>
                                            <form>
                                                <table bgcolor="#FF66CC" align="center">
                                   
                                                    <tr><td><input class="form-control" placeholder="User ID" type="text"></td></tr>
                                                    <tr><td><input class="form-control" placeholder="User Password" type="password"></td></tr>
                                                    
                                 
                                                </table>
                                                <p>By clicking Login in your Account, you agree to our <a href="#">Terms</a> and confirm that you have read our <a href="#">Data Policy</a>, including our <a href="#">Cookie Use Policy</a>. You may receive SMS message notifications from  Manyavar and can opt out at any time.</p>
                                                ...
                                                <input name="Forgot Password?" type="submit" class="btn btn-warning" value="Forgot Password?" id="submit">
                                            </form>
                                        </div>
                                    </div>
                                </div>
